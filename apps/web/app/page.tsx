...
const STEPS = [
  ...
  {
    title: "2. Récupérez votre lien",
    text: "Votre chat en ligne est actif immédiatement, sans rien connecter. Telegram reste disponible en option si vous voulez aussi être jointe depuis l'app.",
  },
  {
